...
function createSortItemTemplate(sortItem) {
  ...
  return (
    `<div class="trip-sort__item  trip-sort__item--${value}">
      <input id="sort-${value}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" data-sort-type="${value}" value="sort-${value}" ${disabled ? 'disabled' : ''} ${value === 'day' ? 'checked' : ''}>
